...
import com.axisrooms.KnightsTemplar.reports.OptimizerPage;
import com.axisrooms.KnightsTemplar.reports.ReportHeaderPage;
import com.axisrooms.KnightsTemplar.utils.AssertionUtility;

public class OptimizerTest extends BaseTest {
	
	private OptimizerTest() {
		
	}

	@Test
	public void optimizerTest(Map<String,String>getData) throws InterruptedException {
		...
		new ReportHeaderPage().getSelectTabFromReportHeader("Optimizer");
		
		new OptimizerPage().getMonthWidget().getSelectMonthFromTable();
